...
public class ArithmeticOperator {
	...
	public static void main(String[] args) {
		...
		a = (int)(10 + 20.3);
		//피연산자의 타입이 서로 다를 경우 표현범위가 큰 쪽으로 형변환후 연산이 수행된다.
		...
		short d = (short)(c - b);
		//int보다 작은 정수 타입은 int로 형변환후 연산이 수행된다.

		long e1 = 100000 * 100000;
		System.out.println(e1); 	//오버플로우 발생
		long e2 = 100000 * 100000L; //피연산자중 하나는 long이어야 결과로 long을 얻을 수 있다.
...
//		int g1 = 10 / 0;			//런타임 에러 발생
		...
		++i;						//전위형 : 변수가 참조되기 전 수행
		i++;						//후위형 : 변수가 참조된 후 수행     //1이 더해지는 시점의 차이
...
//		5.
		...
		int x3 = 31;
		int total = x1 + x2 + x3;
//		double avg = ((int)(total / 3d * 10 + 0.5)) / 10d;		 //sem 답
//		System.out.println("합계 : " + total + "평균 : " + avg);
		System.out.println((int)(total / 3d * 10 + 0.5 ) / 10d); //내답
